  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      ...
      {loading ? (
        ...
        <div className="border-2 border-dashed border-[#E8E5E1] rounded-lg p-12 text-center bg-white">
          ...
          <p className="text-[#6B6B6B] text-sm mb-6 max-w-sm mx-auto">
            Upload your PDF or Word document to get started. We'll extract your skills automatically.
          </p>
