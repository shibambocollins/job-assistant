...
import { Target, Activity, MessageSquare, FileText, ScanEye, ListFilter, FileWarning, ChevronDown } from 'lucide-react';
...
const STEPS = [
  {
    ...
    description: "Upload your CV once. We read it and extract your skills, education, projects, and experience automatically.",
  },
  {
    title: 'Get matched',
    description: 'We compare your profile against real job postings and calculate how closely you actually fit each one.',
  },
  {
    title: 'See your gaps',
    description: "Get a clear breakdown of what's working, what's missing, and concrete suggestions before you apply.",
  },
];
...
const FAQS: Faq[] = [
  {
    ...
    answer: (
      <>
        We take reasonable security measures: passwords are hashed, your CV is stored in a private file container,
        and everything requires you to be logged in. That said, no system can be guaranteed 100% secure. Full
        details are in our{' '}
        <Link to="/privacy-policy" className="text-[#7A5C46] font-medium hover:underline">
          Privacy Policy
        </Link>
        .
      </>
  ...
  {
    question: 'Is Job Assistant AI free to use?',
    answer: "Yes, it's currently free to use while it's being actively developed as a student project.",
  },
  {
    question: 'How accurate is the AI analysis?',
    answer:
      "Match scores and suggestions are generated by an AI model to help guide you, and they're not guaranteed to be perfectly accurate. Use them as a strong starting point, and always apply your own judgment, especially for something as important as a job application.",
  },
  {
    question: 'Where do the job listings come from?',
    answer:
      "We currently discover roles through The Muse job board API. It's a single source for now, with more planned as the project grows.",
  },
  {
    question: 'Can I delete my account and data?',
    answer: (
      <>
        Yes, any time. Just email us and we'll remove your account, CV, and application history. See the{' '}
        <Link to="/privacy-policy" className="text-[#7A5C46] font-medium hover:underline">
          Privacy Policy
        </Link>{' '}
        for details.
...
function FaqItem({ question, answer }: Faq) {
  ...
  return (
    <div className="border-b border-[#E8E5E1] py-5">
      <button
        onClick={() => setOpen((o) => !o)}
        aria-expanded={open}
        className="flex items-center justify-between w-full text-left gap-4"
      >
        <span className="font-medium text-[#1F1F1F]">{question}</span>
        <ChevronDown
          className={`w-5 h-5 text-[#6B6B6B] shrink-0 transition-transform duration-200 ${open ? 'rotate-180' : ''}`}
        />
      </button>
    ...
    <div className="min-h-screen flex flex-col">
      <nav className="flex items-center justify-between px-4 sm:px-8 py-6 max-w-7xl w-full mx-auto">
        ...
        <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-[#5E5A56]">
          ...
          <a href="#how-it-works" className="hover:text-[#1F1F1F]">
            How it works
          </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <Reveal>
            <div className="max-w-2xl mb-16">
              ...
              <p className="text-[#E8E5E1] leading-relaxed">
                ...
                <strong className="text-white">Applicant Tracking System (ATS)</strong>: software companies use it to
          ...
          <Reveal delayMs={100}>
            <p className="text-[#E8E5E1] leading-relaxed max-w-2xl mt-12">
              ...
              you apply instead of wondering why you never heard back.
            </p>
          </Reveal>
        </div>
      </section>

      <section id="how-it-works" className="bg-[#F8F7F4] py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <Reveal>
            <h2 className="text-3xl mb-4">How it works</h2>
          </Reveal>
          <Reveal>
            <p className="text-[#6B6B6B] max-w-xl mb-16">Three steps between you and a CV that actually gets noticed.</p>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {STEPS.map((step, i) => (
              <Reveal key={step.title} delayMs={i * 100}>
                <div>
                  <div className="w-10 h-10 rounded-full bg-[#6F8A68] text-white flex items-center justify-center font-heading text-base mb-5">
                    {i + 1}
                  </div>
            ...
            <Reveal className="md:col-span-8" delayMs={0}>
              <div className="bg-[#F8F7F4] p-8 rounded-lg border border-[#E8E5E1] h-full transition-shadow duration-300 hover:shadow-md">
                ...
                <p className="text-[#6B6B6B] max-w-lg">
                  Upload your CV once. We compare it against real job postings and highlight positions where you
                  have a tangible advantage based on your actual skills, not just keywords.
                </p>
              </div>
            </Reveal>
      ...
      <section id="faq" className="bg-[#F8F7F4] border-t border-[#E8E5E1] py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-8">
          <Reveal>
            <h2 className="text-3xl mb-12">Frequently asked questions</h2>
          </Reveal>
          <Reveal>
            <div className="bg-white border border-[#E8E5E1] rounded-lg px-6">
              {FAQS.map((faq) => (
